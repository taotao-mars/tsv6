...
def evaluate_no_promotion_h123_after_final_joint(
    data_raw1,
    forecast_df,
    scot_df,
    expected_weeks,
    ...
    The cohort must already be the final requested ASIN intersection.  An ASIN
    ...
    print("\n" + "=" * 96)
    print("NO-PROMOTION H1-H3 DIAGNOSTIC | FINAL JOINT COHORT")
    print("=" * 96)
    ...
    if isinstance(all_evaluation, dict):
        for quantile in ["p50", "p70", "p90"]:
            ...
            for cohort_name, table in [
                ("all_origin_eval_scot_chris", all_table),
    ...
    for run_index, row in pairs.iterrows():
        ...
        try:
            ...
            if evaluate_no_promotion_h123:
                no_promotion_diag = evaluate_no_promotion_h123_after_final_joint(
                    data_raw1=data_raw1,
                    forecast_df=forecast_df,
                    scot_df=scot_df,
...
# ============================================================================
# USAGE 4: FIRST FCD | CHRIS ONLY | H1-H3 NO-PROMOTION EVALUATION
# ============================================================================
# Cohort construction:
#   origin ∩ eval ∩ SCOT ∩ Chris
# JIT is deliberately disabled in this standalone usage.  The model is trained
# once on the final four-way intersection.  After
...
#
first_fcd_chris_only_no_promotion_h123 = (
    run_joint_h3_s3_rolling_scot_p50_p70(
        ...
        detach_exposure_for_demand=False,
        output_root=(
            "joint_h3_first_fcd_chris_only_"
