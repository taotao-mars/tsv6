...
# ============================================================================
# USAGE 4: FIRST FCD | CHRIS THEN JIT | H1-H3 NO-PROMOTION EVALUATION
# ============================================================================
# Cohort construction:
#   origin ∩ eval ∩ SCOT ∩ Chris → intersect JIT CSV
# The model is trained once on the final Chris-then-JIT cohort.  After
# prediction, this usage separately evaluates ASINs whose raw ind_promotion is
# zero in H1, H2, and H3.  It also saves ALL-vs-no-promotion WAPE by horizon.
#
# If multiple matching JIT files exist, set the exact path below.
JIT_ASIN_CSV_PATH = None

first_fcd_chris_then_jit_no_promotion_h123 = (
    run_joint_h3_s3_rolling_scot_p50_p70(
        ...
        detach_exposure_for_demand=False,
        output_root=(
            "joint_h3_first_fcd_chris_then_jit_"
            "no_promotion_h123_eval"
        ),
        ...
        run_feature_importance=False,
        evaluate_no_promotion_h123=True,
    )
)
