...
Oracle eval-promotion experiment:
  - uses the realized eval-snapshot ind_promotion for H1-H3;
...
# ============================================================================
# USAGE 4: FIRST FCD ONLY, EVAL IND_PROMOTION ORACLE
# ============================================================================
# This run uses realized eval ind_promotion for the first FCD:
#   data_cut = 2025-10-04
#   FCD      = 2025-10-05
#   H1-H3    = 2025-10-05, 2025-10-12, 2025-10-19
#
# The 2025-10-25 evaluation snapshot supplies actual demand/DPH/OOS and the
# realized H1-H3 ind_promotion feature. promotion_pricing_amount and
# pricing_type are excluded from future_context entirely. No deals table is
# read and no planned value is applied. This is an oracle/leakage benchmark.
#
...
first_fcd_eval_ind_promotion_oracle_jit = run_joint_h3_s3_rolling_scot_p50_p70(
    n_asins=None,
    seed=42,
    max_snapshots=1,
    select_latest=False,
    ...
    lambda_exposure=0.50,
    detach_exposure_for_demand=False,
    output_root="joint_h3_first_fcd_eval_ind_promotion_only_oracle_jit_all",
