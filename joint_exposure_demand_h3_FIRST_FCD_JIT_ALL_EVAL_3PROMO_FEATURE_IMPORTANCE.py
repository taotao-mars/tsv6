...
# ============================================================================
# USAGE 4: FIRST FCD, THREE REALIZED PROMO FEATURES + IMPORTANCE
# ============================================================================
# This run uses all three realized eval promotion features for the first FCD:
#   data_cut = 2025-10-04
#   FCD      = 2025-10-05
#   H1-H3    = 2025-10-05, 2025-10-12, 2025-10-19
#
# The 2025-10-25 evaluation snapshot supplies actual demand/DPH/OOS plus
# ind_promotion, promotion_pricing_amount, and pricing_type. No deals table is
# read and no planned value is applied. After training, each feature is
# permuted separately to measure demand and exposure WAPE degradation.
#
...
first_fcd_eval_three_promo_importance_jit = run_joint_h3_s3_rolling_scot_p50_p70(
    n_asins=None,
    seed=42,
    max_snapshots=1,
    select_latest=False,
    ...
    lambda_exposure=0.50,
    detach_exposure_for_demand=False,
    output_root="joint_h3_first_fcd_eval_3promo_feature_importance_jit_all",
